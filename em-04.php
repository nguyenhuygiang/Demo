...
<html>
    ...
    <body style="font-family: 'Myriad Pro', arial, tahoma;">
        <div style="width: 600px; margin: 0 auto; font-family: Myriad Pro; font-size: 18px;">
            ...
            <h1 style="font-size: 25px; color: #810c15; font-weight: bold; text-align: center;">ANH/CHỊ ĐÃ KIỂM TRA KỸ THUẬT CHƯA?</h1>
            <div style="margin-left: 25px;">
                <p><b>Chào anh/chị,</b> <br>Topica Native xác nhận việc đăng ký học thử của anh/chị</p>
            </div>
            ...
            <div style="width: 552px; height: 240px;; margin-left: 25px; background-color: #e5e5e5; margin-top: 30px;">
                <div style="width: 100%; height: 40px; background-color: #810c15; border-top-left-radius: 5px; border-top-right-radius: 5px;margin-bottom:30px">
                    <p style="color: #fff; margin-left: 15px; padding: 12px 5px;">Ấn vào nút bên dưới để tiến hành kiểm tra kỹ thuật<p>
                </div> 
                <div>
                    <a  href="#" style="
                        ...
                        padding: 15px 20px;">Kiểm tra kỹ thuật
                    </a>
                </div>
                <img src="./img/thiet-bi.png" alt="" style="margin: 30px 0 0 25px;">
                <p style="text-align: center;">Lưu ý: Kiểm tra kỹ thuật là bước bắt buộc trước khi học thử</p>
            </div>
